...
public class ProdutoController {
    ...
    public ResponseEntity<List<ProdutoVO>> findAll(@PathVariable(value = "email") String email) {
    ...
    public ResponseEntity<ProdutoVO> findById(@PathVariable(value = "email") String email, @PathVariable(value = "id_product") Long idProduct) {
        return services.findById(email, idProduct);
    }
    ...
    public ResponseEntity<?> delete(@PathVariable(value = "email") String email, @PathVariable(value = "id_product") Long idProduct) {
        services.delete(email, idProduct);
